...
class OverlayState extends State<Overlay> with TickerProviderStateMixin {
  ...
  bool _debugVerifyInsertPosition(OverlayEntry? above, OverlayEntry? below,
    ...
    'The provided entry used for `above` must be present in the Overlay${newEntries !=
        null ? ' and in the `newEntriesList`' : ''}.',
    );
    assert(
    below == null ||
        (below._overlay == this &&
    ...
    'The provided entry used for `below` must be present in the Overlay${newEntries !=
        null ? ' and in the `newEntriesList`' : ''}.',
    );
    return true;
  }
